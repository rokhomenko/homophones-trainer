...
<template>
  ...
  <div class="flex flex-col justify-between gap-12">
    <div class="mx-auto flex w-full max-w-4xl flex-col items-center border border-stone-800/90 bg-[#15130f]/88 px-5 py-8 text-center shadow-[0_18px_70px_rgb(0_0_0/0.28)] rounded-[2rem] sm:px-8" v-if="!trainingStore.finished">
      ...
      <button v-if="trainingStore.currentWord?.word.word" :disabled="isDisabled"
        @click="handleSpeak(trainingStore.currentWord?.word.word)" class="my-14 rounded-full border border-stone-700 bg-[#0f0e0c] p-8 text-stone-200 shadow-[0_0_50px_rgb(140_63_45/0.16)] hover:border-[#9e553a] hover:text-[#d99165] disabled:opacity-50">
      ...
      <button class="mb-2 mt-16 cursor-pointer text-sm font-black uppercase tracking-[0.24em] text-stone-300 hover:text-[#d99165] disabled:cursor-not-allowed disabled:opacity-30" @click="nextWord()" :disabled="!answeredCurrentWord">
